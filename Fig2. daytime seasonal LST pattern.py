...
day_jja=real.iloc[:,161:164].mean(1)*10
day_djf=pd.concat([real.iloc[:,167:168].mean(1),real.iloc[:,156:158]],axis=1).mean(1)*10
day_mam=real.iloc[:,158:161].mean(1)*10
day_son=real.iloc[:,164:167].mean(1)*10
...
sns.distplot(day_mam,color="g",bins=30,ax=ax1)
#ax1.set_xlabel('')
...
ax1.set_xlim(-5,5)
ax1.text(0.6,0.7,day_mam_str,fontsize=8,transform=ax1.transAxes)
...
sns.distplot(day_jja,color="g",bins=30,ax=ax2)
#ax1.set_xlabel('')
...
ax2.set_xlim(-5,5)
ax2.text(0.6,0.7,day_djf_str,fontsize=8,transform=ax2.transAxes)
...
sns.distplot(day_son,color="g",bins=30,ax=ax3)
#ax1.set_xlabel('')
...
ax3.set_xlim(-5,5)
ax3.text(0.6,0.7,day_son_str,fontsize=8,transform=ax3.transAxes)
#ax2 = fig.add_axes([left, bottom, width, height])
#sns.distplot(night_annual,color="r",bins=30,kde=True)
#ax2.set_xlabel('LST changed')
#ax2.set_ylabel('Counts')
...
sns.distplot(day_djf,color="g",bins=30,ax=ax4)
#ax1.set_xlabel('')
...
ax4.set_xlim(-5,5)
ax4.text(0.6,0.7,day_djf_str,fontsize=8,transform=ax4.transAxes)
#ax2 = fig.add_axes([left, bottom, width, height])
#sns.distplot(night_annual,color="r",bins=30,kde=True)
#ax2.set_xlabel('LST changed')
#ax2.set_ylabel('Counts')
...
cb.set_label_text(r'Daytime $\theta$LST(℃)',fontsize=24)


#plt.savefig('/mnt/e/US/figure/fig2.daytime seasonal lst trend.jpg',dpi=300)
plt.show()
#
